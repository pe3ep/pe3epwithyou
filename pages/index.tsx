...
export default function Home() {
  const socials = [
    {
      ...
      icon: (
        <svg
          className="h-4 w-4 fill-yellow-900"
  ...
  return (
    <>
      ...
      <main>
        <div
          className={`flex p-5 md:pt-12 lg:pt-32 tracking-wide flex-wrap justify-start text-yellow-900 ${font.className} font-bold text-8xl md:text-9xl lg:justify-center`}>
          <h1>pe3ep</h1>
          <h1>with</h1>
          <h1>you</h1>
        </div>
        ...
        <div className="max-w-md mx-auto px-5">
          <div className="flex justify-between items-center mx-1">
            <p className={`text-yellow-900 font-bold`}>links</p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className="border border-yellow-900"></div>
        </div>
        <div className="max-w-md mx-auto px-5">
          <div className="flex flex-col">
            {socials.map((item) => (
              <a
                href={item.link}
                key={item.id}
                className={`transition flex justify-between items-center gap-2 duration-250 py-2 px-1 border-b border-yellow-900 hover:bg-yellow-200/20 focus:bg-yellow-300/20 focus:outline-0 text-yellow-900`}>
                {item.name}
                {item.icon}
              </a>
            ))}
